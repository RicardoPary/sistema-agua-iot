...
@Component({
  selector: 'app-semaphore-time',
  templateUrl: './semaphore-time.component.html',
  styleUrls: ['./semaphore-time.component.scss']
})
export class SemaphoreTimeComponent implements OnInit {
