...
@Component({
  selector: 'app-datos-conduct',
  templateUrl: './datos-conduct.component.html',
  styleUrls: ['./datos-conduct.component.scss']
})
export class DatosConductComponent implements OnInit {
